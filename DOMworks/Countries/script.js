...
function displayCountries(countries){
    ...
    for(let c of countries){
        ...
        htmlData += `<div class="relative aspect-[16/9]  w-auto rounded-md md:aspect-auto md:h-[400px]">
          <img
            src="${c.flag}"
            alt="AirMax Pro"
          ...
          <div class="absolute bottom-4 left-4 text-left">
            ...
            <p class="mt-2 text-sm text-gray-300">Population ${c.population}</p>
            <p class="mt-2 text-sm text-gray-300">Timezone ${c.timezones}</p>
