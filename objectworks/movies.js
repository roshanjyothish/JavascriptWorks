...
// var heightestRuntimeMovie=filims.reduce((m1,m2)=>Number(m1.runtime)>Number(m2.runtime)?m1:m2)

// console.log(heightestRuntimeMovie);
...
var movieDramaAction=filims.filter(f=>f.genres.includes("Action") || f.genres.includes("Drama")).map(f=>f.title);

console.log(movieDramaAction);
